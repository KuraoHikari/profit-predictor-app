...
import UsePredictWithForm from "@/hooks/usePredictWithForm";
  ...
  <>
   <main className="bg-gray-100 min-h-screen flex items-center justify-center font-sans p-4">
    <div className="w-full max-w-2xl bg-white rounded-2xl shadow-xl p-8 space-y-8">
     ...
     {/* Hasil Prediksi */}
     {(predictedProfit !== null || isLoading) && <PredictionResult isLoading={isLoading} predictedProfit={predictedProfit} predictionRange={predictionRange} />}
    </div>
   </main>
  </>
 );
